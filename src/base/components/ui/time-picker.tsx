      ...
      <PopoverTrigger asChild onClick={readOnly ? (e) => e.preventDefault() : undefined}>
        ...
        >
          ...
          {date ? (
            ...
            <span>
              {placeholder ?? getTranslation('base.components.ui.TimePicker.placeholder')}
            </span>
          )}
        </Button>
      </PopoverTrigger>
...
function TimePickerInput12h(
  props: TimeInputProps &
    Required<Pick<TimeInputProps, 'date' | 'onDateChange'>> & {
      onSetToNow?: () => void;
    }
) {
  const id = useId();
  ...
  return (
    <div className='space-y-2'>
      <div className='flex justify-center gap-2'>
        <div className='flex flex-col items-center justify-center gap-1'>
          <Label htmlFor='hours' className='text-xs'>
            {getTranslation('base.components.ui.TimePicker.hours')}
          </Label>
        ...
        <div className='flex flex-col items-center gap-1'>
          <Label htmlFor='minutes' className='text-xs'>
            {getTranslation('base.components.ui.TimePicker.minutes')}
          </Label>
          <TimePickerEntryInput
            picker='minutes'
            id={`${id}-minutes12`}
        ...
        {props.includeSeconds && (
          <div className='flex flex-col items-center gap-1'>
            <Label htmlFor='seconds' className='text-xs'>
              {getTranslation('base.components.ui.TimePicker.seconds')}
            </Label>
            <TimePickerEntryInput
              picker='seconds'
              id={`${id}-seconds12`}
        ...
        <div className='flex flex-col items-center gap-1 text-center'>
          <Label htmlFor='period' className='text-xs'>
            {getTranslation('base.components.ui.TimePicker.period')}
          </Label>
          <TimePeriodSelect
            period={period}
            setPeriod={setPeriod}
      ...
      >
        {getTranslation('base.components.ui.TimePicker.setToNow')}
      </Button>
    </div>
  );
}
