    ...
    return (
      <Drawer>
        <DrawerTrigger asChild onClick={readOnly ? (e) => e.preventDefault() : undefined}>
          <Button
            ...
            title={renderPickerText({
              ...
              formatString,
              placeholder,
              defaultPlaceholder: getTranslation('base.components.ui.DateTimePicker.placeholder'),
            })}
          >
        ...
        <DrawerContent>
          ...
          <Calendar mode='single' selected={date} onSelect={(d) => handleSelect(d)} autoFocus />
          <Separator />
          <div className='w-full space-y-2 p-4'>
            {toggleTime && (
              <div className='flex items-center gap-2'>
                <Checkbox
                  id={`${id}-date-time-picker-show-time`}
                  checked={includeTime}
      ...
      <PopoverTrigger asChild onClick={readOnly ? (e) => e.preventDefault() : undefined}>
        <Button
          ...
          title={renderPickerText({
            ...
            formatString,
            placeholder,
            defaultPlaceholder: 'Pick a date & time',
          })}
        >
          <CalendarDaysIcon className='mr-2 h-4 w-4' />
          <span className='truncate'>
