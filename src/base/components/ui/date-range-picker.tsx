        ...
        <DrawerTrigger asChild onClick={readOnly ? (e) => e.preventDefault() : undefined}>
          <Button
            ...
            title={renderPickerText({
              formatString,
              defaultPlaceholder: getTranslation('base.components.ui.DateRangePicker.placeholder'),
              locale,
              dateRange,
              placeholder,
            })}
            ...
            <span className='truncate'>
              {renderPickerText({
                ...
                defaultPlaceholder: getTranslation(
                  'base.components.ui.DateRangePicker.placeholder'
                ),
                locale,
                dateRange,
                placeholder,
